...
export default function Navbar() {
    ...
    return (
        <header className='w-full bg-white md:bg-transparent fixed top-0 left-0 right-0'>
            <nav className={`py-4 ls:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border-b bg-white duration-300" : ""}`}>
                <div className='flex justify-between items-center text-base gap-8'>
                    <a href="" className='text-2x1 font-semibold flex items-center space-x-3'><img src={''}
              ...
              '>NEXCENT</span></a>
                  ...
                  first:font-medium'>{link}</Link>)
                    ...
                    <div className='space-x-12 hidden lg:flex items-center pr-12'>
